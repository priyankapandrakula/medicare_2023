...
let currentDate = `${day}-${month}-${year}`;
  ...
  return (
    <div className='' >
               <img src="https://www.hopkinsmedicine.org/-/media/images/health/3_-wellness/living-with-a-chronic-disease/help-for-managing-multiple-medications-hero.ashx?h=500&iar=0&mh=500&mw=1300&w=1297&hash=122DB3C1DCAD683F2F7CAE139A67613C" style={{position:'absolute', width:"100%",opacity:'.7'}} height={600    } />
